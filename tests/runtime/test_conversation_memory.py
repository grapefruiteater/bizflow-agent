...
class FakeMemoryClient:
    ...
    def get_last_k_turns(
        ...
        assert actor_id == f"bizflow-session/{SESSION_ID}"
...
def make_memory(client: FakeMemoryClient) -> AgentCoreConversationMemory:
    return AgentCoreConversationMemory(MEMORY_ID, "ap-northeast-1", client)
